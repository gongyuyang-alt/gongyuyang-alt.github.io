...
- `role`、`affiliation`、`affiliation_url`、`location`：当前身份与单位
- `advisor`：当前导师姓名与主页
- `education`：学位、学校、时间和成绩

首页 Biography、Research Focus 等文字在 `_pages/about.md` 中更新。
...
- `tags`
- `paper_url`、`code_url`
- `selected: true`：显示在首页；`false`：仅保留在数据文件中
...
- 页面颜色和排版：`_sass/_minimal-polish.scss`
